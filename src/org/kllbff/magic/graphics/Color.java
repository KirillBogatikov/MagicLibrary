    ...
    public static long parseHEX(String hex) {
        ...
        switch(hex.length()) {
            case 4: {
                ...
                g = Integer.parseInt(hex.substring(2, 3));
                b = Integer.parseInt(hex.substring(3, 4));
                a = 0xFF;
            } break;
            case 5: {
                r = Integer.parseInt(hex.substring(1, 2));
                g = Integer.parseInt(hex.substring(2, 3));
                b = Integer.parseInt(hex.substring(3, 4));
                a = Integer.parseInt(hex.substring(4, 5));
            } break;
            case 7: {
                r = Integer.parseInt(hex.substring(1, 3));
                g = Integer.parseInt(hex.substring(3, 5));
                b = Integer.parseInt(hex.substring(5, 7));
                a = 0xFF;
            } break;
            case 9: {
                r = Integer.parseInt(hex.substring(1, 3));
                g = Integer.parseInt(hex.substring(3, 5));
                b = Integer.parseInt(hex.substring(5, 7));
                a = Integer.parseInt(hex.substring(7, 9));
            } break;
        }
